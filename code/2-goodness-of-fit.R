...
# The internal model fit checks don't work with joiners and leavers
# To circumvent this, we replace NA's to structural 0's (i.e., 10's)
...
# There doesn't seem that there should be any notable higher-order effects
...
m1_outdeg <- sienaGOF(model1, varName = "sponsorships",  OutdegreeDistribution)
m1_indeg <- sienaGOF(model1, varName = "sponsorships",  IndegreeDistribution)
...
eff2 <- includeTimeDummy(eff2, egoX, interaction1 = "prior_years")
...
eff2 <- includeTimeDummy(eff2, density)
...
m2_outdeg <- sienaGOF(model2, varName = "sponsorships",  OutdegreeDistribution)
m2_indeg <- sienaGOF(model2, varName = "sponsorships",  IndegreeDistribution)
...
# Add time dummies for female alter 
...
m3_outdeg <- sienaGOF(model3, varName = "sponsorships",  OutdegreeDistribution)
m3_indeg <- sienaGOF(model3, varName = "sponsorships",  IndegreeDistribution)


# Save everything
save.image("./2-analyses/GoF.RData")
